        ...
        <div id="aboutMe">
            ...
            <div className="columns2">
                ...
                <div className="col2">
                    <h2>Highlights</h2>
                    <ul>
                        <li>Designed and implemented a driver performance monitoring and reporting system that helped to identify unnecessary stops, extended breaks, and deviations from route planning. No tool for assessing route efficiency was in place before this tool, saw a 12% reduction in paid overtime.</li>
                        <li>Designed and implemented a route status reporting tool that incorporated automated HTML email reports.</li>
                        <li>Designed a bar-code solution currently used to track and build customer shipments.</li>
                        <li>Devised a route planning tool that combined historical delivery data with Google Maps routing to provide accurate routing estimates.</li>
                        <li>Implemented an Access client upgrade tool. Provided automated alerts to client users and automated the upgrade process for the users client application.</li>
                        <li>Designed and implemented a raw material discrepancy tracking system that reduced shortages by 80%.</li>
                        <li>Designed and implemented a raw material reordering system that reduced time spent assessing plant needs by 90%, and helped to reduce on-hand inventories by 20%.</li>
                        <li>Designed and implemented a raw material staging process that provided status updates, manged staging processed, and printed labels.</li>
                        <li>Designed and implemented a site wide MRO ordering and approval system used for office, maintenance, safety and production materials. Was instrumental in collecting data concerning buying habits and reducing waste.</li>
                        <li>Designed and implemented a site wide server storage system and retrieval system for MSDS sheets.</li>
                    </ul>
                </div>
            </div>
        </div>
